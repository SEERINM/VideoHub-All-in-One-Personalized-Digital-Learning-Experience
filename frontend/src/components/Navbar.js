...
export default function Navbar() {
  ...
  return (
    <nav style={{
      ...
      boxShadow: "0 2px 18px #0001", zIndex: 99, display: "flex", alignItems: "center",
      justifyContent: "space-between", padding: "0 2vw", height: "64px"
    }}>
     
      <div style={{ display: "flex", alignItems: "center", gap: "11px" }}>
        <LogoIcon />
        <span style={{
          fontWeight: 700, fontSize: "1.67rem",
          background: "linear-gradient(90deg,#764ba2,#667eea)",
      ...
      <div style={{ display: "flex", gap: "2vw" }}>
        <Link className="nav-link" to="/home" style={navLinkStyle}>Home</Link>
        <Link className="nav-link" to="/services" style={navLinkStyle}>Our Services</Link>
        <span
          className="nav-link"
          style={navLinkStyle}
          onClick={() => {
  ...
  return (
    <div className="navbar">
      <div className="nav-left">
        <div className="brand">MyVideoSuite</div>
        <div style={{fontSize:14}}>A small suite for video tasks</div>
      </div>
